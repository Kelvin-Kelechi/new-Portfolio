...
export default function ProjectShowcase({
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-12 items-center gap-x-gutter gap-y-10 py-band lg:gap-y-0">
        {/* ── The visual ───────────────────────────────────────────────── */}
        <div
          ...
          >
            <Tilt max={4} className={kind === "phone" ? "mx-auto max-w-[19rem]" : ""}>
              <div className="showcase-frame rounded-[inherit]">
                ...
                >
                  {/* Phones are portrait, browsers landscape. Using one ratio
                      for both would letterbox whichever it was not chosen for. */}
        ...
        <div
          className={`col-span-12 lg:col-span-5 ${
            flipped ? "lg:order-1 lg:col-start-1 lg:pr-6" : "lg:order-2 lg:pl-6"
          }`}
        >
